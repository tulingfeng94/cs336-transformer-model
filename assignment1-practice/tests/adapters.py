...
def run_linear(
    ...
    linear_module.weights.data = weights
...
def run_multihead_self_attention(
    ...
    return MultiheadSelfAttention(d_model, num_heads, 0, 0, q_proj_weight, k_proj_weight, v_proj_weight, o_proj_weight, in_features)
...
def run_multihead_self_attention_with_rope(
    ...
    """
    from cs336_basics.transformer import MultiheadSelfAttention
    return MultiheadSelfAttention(d_model, num_heads, max_seq_len, theta, q_proj_weight, k_proj_weight, v_proj_weight, o_proj_weight, in_features, token_positions)
...
def run_transformer_block(
    ...
    """
    from cs336_basics.transformer import build_transformer_block
    return build_transformer_block(d_model, num_heads, d_ff, max_seq_len, theta, weights, in_features)
...
def run_transformer_lm(
    ...
    """
    from cs336_basics.transformer import build_transformer_lm

    return build_transformer_lm(vocab_size, context_length, d_model, num_layers, num_heads, d_ff, rope_theta, weights, in_indices)
...
def run_cross_entropy(
    ...
    """
    from cs336_basics.transformer import CrossEntropyLoss
...
def run_save_checkpoint(
    ...
    return save_checkpoint(out, model, optimizer, iteration)
...
def run_train_bpe(
    ...
    **kwargs,
    ...
    return bpe_tokenizer_training(str(input_path), vocab_size, special_tokens)
